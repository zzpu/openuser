  ...
  return (
    <Tabs
      ...
      <TabItem value="express">
        <CodeFromRemote
          lang="js"
          link={`https://github.com/zzpu/openuser-selfservice-ui-node/blob/master/src/routes/${flow}.ts`}
        ...
        <Tabs
          ...
          <TabItem value="view">
            <CodeFromRemote
              lang="handlebars"
              link={`https://github.com/zzpu/openuser-selfservice-ui-node/blob/master/views/${flow}.hbs`}
          ...
          <TabItem value="generic-form">
            <CodeFromRemote
              lang="handlebars"
              link="https://github.com/zzpu/openuser-selfservice-ui-node/blob/master/views/partials/form.hbs"
          ...
          <TabItem value="input-form">
            <CodeFromRemote
              lang="handlebars"
              link="https://github.com/zzpu/openuser-selfservice-ui-node/blob/master/views/partials/form_input_default.hbs"
        ...
        <a href="https://github.com/zzpu/openuser-selfservice-ui-node/tree/master/views/partials">here</a>.
      </TabItem>
      <TabItem value="react">
