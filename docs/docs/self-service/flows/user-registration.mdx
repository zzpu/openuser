...
<CodeFromRemote
  language="json"
  link="https://github.com/zzpu/openuser/blob/master/contrib/quickstart/kratos/email-password/identity.schema.json"
...
[kratos#273](https://github.com/zzpu/openuser/issues/273)
