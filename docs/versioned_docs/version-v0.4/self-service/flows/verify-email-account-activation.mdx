...
- [Verification HTTP Route](https://github.com/zzpu/ums-selfservice-ui-node/blob/master/src/routes/verify.ts)
- [Verification UI](https://github.com/zzpu/ums-selfservice-ui-node/blob/master/views/verify.hbs)
