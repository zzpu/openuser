...
free to [open an issue](https://github.com/zzpu/openuser/issues/new/choose).
...
2. [SecureApp](http://github.com/zzpu/openuser-selfservice-ui-node)
...
1. SecureApp used the ORY Kratos JavaScript language client to
   [guard the `/dashboard`](https://github.com/zzpu/openuser-selfservice-ui-node/blob/v0.4.6-alpha.1/src/index.ts#L111)
...
2. The route guard redirected you from `/dashboard` to `/auth/login`. ORY
   ...
   [couldn't find it](https://github.com/zzpu/openuser-selfservice-ui-node/blob/2f097b519644d2663e277398213aaa1103b74cf9/src/routes/auth.ts#L26),
...
[`./contrib/quickstart/kratos`](https://github.com/zzpu/openuser/tree/v0.4.6-alpha.1/contrib/quickstart/kratos/email-password)
,
[`./quickstart.yml`](https://github.com/zzpu/openuser/blob/v0.4.6-alpha.1/quickstart.yml),
and
[`./quickstart-standalone.yml`](https://github.com/zzpu/openuser/blob/v0.4.6-alpha.1/quickstart-standalone.yml).
...
values for
[`identity.default_schema_url`](https://github.com/zzpu/openuser/blob/v0.4.6-alpha.1/contrib/quickstart/kratos/email-password/.kratos.yml#L67)
and
[`DSN`](https://github.com/zzpu/openuser/blob/v0.4.6-alpha.1/quickstart.yml#L42).
You should also configure
[`selfservice.flows.*.ui_url`](https://github.com/zzpu/openuser/blob/v0.4.6-alpha.1/contrib/quickstart/kratos/email-password/.kratos.yml#L40)
