...
change using the [Argon2 Hashing Algorithm](../../concepts/security.mdx#Argon2), the
...
[Identity Data Model Chapter](../../concepts/identity-data-model.md) in the docs'
concepts section.
...
in
[Selfservice Registration](../../self-service/flows/user-login-user-registration/username-email-password.mdx)):
