...
the (https://github.com/P-H-C/phc-winner-argon2)[Password Hashing Competition (PHC)].
...
[Identity Data Model Chapter](../../concepts/identity-user-model) in the docs' concepts section.
...
"john.doe.from.newyork.1970", but finding the right username identifier is
