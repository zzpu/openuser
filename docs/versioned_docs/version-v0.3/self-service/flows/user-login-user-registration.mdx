...
[social](user-login-user-registration/openid-connect-social-sign-in-oauth2.mdx) sign in and sign
up strategies.
...
[reference implementation](https://github.com/zzpu/openuser-selfservice-ui-node))
