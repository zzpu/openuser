...
Please the [User Settings Documentation](../user-settings.mdx) first.
...
initiates the flow. The Settings Request Response Payload always include a `profile` method:
