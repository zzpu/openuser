...
[open an issue](https://github.com/zzpu/ums/issues/new/choose).
...
If we try to sign up using a password like `123456`, ORY Kratos' password policy
will complain:
...
The error message is coming directly from ORY Kratos' API:
